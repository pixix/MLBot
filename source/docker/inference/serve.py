...
print("Downloading from s3://{}/{}/model.tar to {}".format(model_bucket, model_prefix, model_dir))

s3 = boto3.client('s3', region_name="cn-north-1")
key = "{}/model.tar".format(model_prefix)
fullpath = os.path.join(model_dir, "model.tar")
